                  ...
                  {categories.map(cat => (
                    <section key={cat}>
                      <div className="flex items-center gap-3 mb-3">
                        <h3 className="text-[15px] font-extrabold text-ink uppercase tracking-widest">{cat}</h3>
                        <span className="h-px flex-1 bg-hair" />
                        <span className="text-xs font-semibold tabular text-ink-3">{byCategory[cat].length}</span>
                      </div>
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
