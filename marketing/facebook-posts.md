...
✕ "Saan napunta yung kita?" sa katapusan ng buwan
✕ Manual na food cost computation kada lingo
✕ Sahod na kinakalkula sa notebook tuwing Linggo gabi
✕ Stockouts ng gatas, asukal, at kape tuwing Saturday rush
✕ $40-60 USD/month na bayarin sa foreign POS

ANO ANG MAITUTULONG SA'YO:
✓ POS na gumagana sa phone — walang bibilhin na hardware
✓ Real-time food cost % per dish (alam mo agad kung sumosobra)
✓ Low-stock alerts BEFORE ka maubusan
✓ Payroll na nag-fill-up sa sarili niya based sa shifts mo
✓ AI co-pilot na pwede mong kausapin sa Tagalog ("Magkano ang gastos ko nung Sabado?")
✓ Public QR menu para sa customers mo — libre, walang extra subscription
✓ GCash, GoTyme, at BPI bayaran — no card needed, walang FX gulo

PRESYO:
🆓 FREE forever para sa 1 venue
💎 Pro — ₱399/buwan o ₱4,000/taon (14-day free trial, no card)
...
## 🔥 Post 2 — Pain hook (short, punchy)

**Use:** Scroll-stopper. Good for organic reach + boosted posts.
**Image:** `marketing/landing/02-the-problem-running-a-caf-shouldn-t-feel-like-this.png`

```
Linggo ng gabi. 11 PM. Naka-Excel ka pa rin. ☕😴

May notebook ka sa kaliwa, GCash receipts sa kanan, at Square sa cellphone — pinipilit pagsamahin para malaman lang kung kumita ka ngayong linggo.
...
**Use:** Targeting café/coffee shop owners specifically.
**Image:** `marketing/landing/04-features.png` or `marketing/landing/07-pos-section.png`

```
Sa mga café owners diyan — alam mo ba ang TUNAY na cost mo per latte? ☕
...
## 🍚 Post 4 — Karinderya / Turo-turo owners

**Use:** Reaches a HUGE underserved segment in PH.
**Image:** `marketing/landing/05-getting-started-up-and-running-in-minutes.png`

```
Sa mga may karinderya at kainan — yes, para rin sa inyo 'to. 🍚
...
✓ AI tips na nakasulat sa Tagalog ("Mukhang kulang ang adobo nung Sabado, baka dagdagan mo next week")
✓ Free forever para sa 1 venue — walang hidden charges
...
## 🍕 Post 5 — Pizzeria / delivery-first

**Use:** Pizzerias, burger joints, fast-casual.
**Image:** `marketing/landing/07-pos-section.png`

```
Pizzeria owners — alam niyo ba kung saan kayo kumikita talaga? Dine-in, takeout, o delivery? 🍕
...
## 🧋 Post 6 — Boba / milk tea / mall kiosk

**Use:** Boba shops, juice bars, dessert shops.
**Image:** `marketing/landing/04-features.png`

```
Milk tea owners 🧋 — tracked mo ba ang TUNAY na cost per cup?
...
✓ Group orders (Grab batches) one-tap log
✓ Multi-location kung may 2+ branches ka (Pro)
...
## 📊 Post 7 — AI co-pilot spotlight

**Use:** Showcase the AI feature (premium hook).
**Image:** `marketing/landing/10-reports-section.png` or `marketing/landing/03-owner-scene.png`

```
Imagine — gising ka ng 7 AM, may text na sa'yo:
...
- "Aling dish ang pinakamalaki margin?"
- "Aling supplier ang pinakamahal nung last month?"
...
## 💰 Post 8 — Case study (Lina ROI)

**Use:** Social proof. Pin to top of page.
...
😩 Payroll Sunday 11 PM, double-entry sa notebook

Pagkatapos ng 90 araw:
✅ 15 minuto na lang gabi-gabi — AI digest ang nagre-review
✅ Food cost 32%, monitored daily
✅ Zero surprise stockouts — alerts ng 9 AM
✅ Payroll auto-fills from shifts — 5 minutes tapos
✅ Monthly net: +45% (₱18K na naipon kada buwan, same revenue)
...
## ⏰ Post 9 — Founding 100 cafés (urgency)

**Use:** When you want to push signups. Re-post every 2 weeks until 100 hit.
**Image:** screenshot of brochure page 11 (`marketing/brochure-preview/page-11.png`)
...
🎁 Free migration from Square, Loyverse, o spreadsheet — papasok namin yung data mo, libreng setup
✅ Cancel anytime, full CSV export of your data
💬 Direct DM support from me (RJ, founder)
...
## ❓ Post 10 — FAQ (objection handler)

**Use:** Answer common DMs in one post. Save replies time.
**Image:** screenshot of brochure page 10 (`marketing/brochure-preview/page-10.png`)

```
Nakaka-receive kami ng mga DMs — sagutin natin lahat dito sa post na 'to. 🙋

❓ "May Square na ako, worth ba mag-switch?"
→ Kung kailangan mo ng food cost, margin tracking, o AI insights — yes. Free yung first month for migrators (papasok namin yung Square data mo). Pwede pa parallel run for a week para makompara mo.

❓ "Karinderya lang ako, gagana ba?"
→ Yes, one of our 7 default templates. Walang POS hardware needed, log via phone, free forever tier.

❓ "Hindi ako techie, kaya ko ba?"
→ Kung kaya mong gamitin yung Messenger at GCash, kaya mo to. 60-second signup, in-app tutorials, at libreng DM support sa founder.

❓ "Pano kung ma-down yung app?"
→ Hosted sa Vercel + Supabase (same infra as thousands of production apps). 99.9% uptime target. POS works offline pa rin tapos syncs pag reconnected.

❓ "Pwede ko bang i-cancel?"
→ Anytime. Downgrade to Free (keep using core dashboard) o request full CSV export. Yung data mo, sa'yo pa rin.
...
## 🎯 Suggested 14-day post cadence

| Day | Post # | Goal |
|----|-------|------|
| 1 | Post 1 (Launch) | Big reveal, set context |
| 2 | Post 2 (Pain hook) | Reach scrollers |
| 3 | Post 11 (Short hook) | Story / boost |
| 4 | Post 3 (Café) | Vertical-specific |
| 5 | Post 8 (Case study) | Social proof |
| 6 | Post 4 (Karinderya) | Vertical |
| 7 | Post 7 (AI spotlight) | Feature highlight |
| 8 | Post 11 (Short hook) | Reset attention |
| 9 | Post 5 (Pizzeria) | Vertical |
| 10 | Post 9 (Founding 100) | Urgency |
| 11 | Post 6 (Boba) | Vertical |
| 12 | Post 10 (FAQ) | Pre-handle objections |
| 13 | Post 2 (Pain hook, reposted) | New audience |
| 14 | Post 1 (Launch, reposted) | Catch new followers |

After 14 days, rotate: any post can be reposted every 3–4 weeks with slight tweaks (different image, new opening line, fresh case study number).
...
| 5 | POS section | `marketing/landing/07-pos-section.png` |
| 6 | Features grid | `marketing/landing/04-features.png` |
| 7 | Reports / AI section | `marketing/landing/10-reports-section.png` |
| 8 | Case study page | `marketing/brochure-preview/page-08.png` |
| 9 | Founding offer page | `marketing/brochure-preview/page-11.png` |
| 10 | FAQ page | `marketing/brochure-preview/page-10.png` |
...
## 💡 Posting tips for PH F&B audience

- **8–10 AM** and **8–10 PM** are highest-engagement windows for restaurant owners (before/after service)
- Use **🇵🇭** flag emoji sparingly — once per post max, feels patriotic without being cheesy
- **Tagalog comments invite Tagalog responses** — if you reply in English, you'll get English back. Match the vibe.
- For boosted posts, target by interest: "Filipino restaurant owners", "Cafe owners Philippines", "Food business Philippines"
- Pin **Post 1 (Launch)** to the top of your page until you have 100 sign-ups
- Tag relevant communities: Cafe PH, Restaurant Owners PH, Karinderya Owners (search FB for active groups)
